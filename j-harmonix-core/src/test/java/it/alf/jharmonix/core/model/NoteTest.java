...
class NoteTest {
    ...
    void transposeWraps() {
        ...
        assertThat(c.transpose(12)).isEqualTo(c);
        assertThat(c.transpose(-1)).isEqualTo(Note.fromName("B"));
        assertThat(c.transpose(7)).isEqualTo(Note.fromName("G"));
    }
    ...
    void intervalTo() {
        ...
        assertThat(c.intervalTo(g)).isEqualTo(7);
        assertThat(g.intervalTo(c)).isEqualTo(5);
    }
