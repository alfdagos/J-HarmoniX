package org.jharmonix.cli.command;
 ...
 *
 * <p>All public {@code @ShellMethod} methods are automatically registered as
 * interactive shell commands. Tab-completion and help text are derived from
 * the method and parameter Javadoc / annotations.
 *
 * <h3>Available commands</h3>
 * <ul>
 *   <li>{@code generate} – generates a chord progression based on user parameters</li>
 *   <li>{@code scales}   – lists all available scale types</li>
 *   <li>{@code styles}   – lists available harmony styles</li>
 * </ul>
 */
@ShellComponent
public class HarmonyCliCommands {
    ...
    /**
     * Generates a harmonic progression and prints it to the console.
     *
     * <p>Example:
     * <pre>
     *   jharmonix:> generate --tonic C --scale MAJOR --form AABA --style JAZZ_STANDARD --complexity SEVENTH_CHORDS
     * </pre>
     *
     * @param tonic      root note of the key (e.g. C, F#, Bb)
     * @param scale      scale type (see {@code scales} command for valid values)
     * @param form       song form token string (e.g. AABA, verse-chorus-bridge)
     * @param style      harmony style (SIMPLE, POP, JAZZ_STANDARD, JAZZ_MODERN)
     * @param complexity chord complexity (TRIADS, SEVENTH_CHORDS, NINTHS, FULL_EXTENSIONS)
     * @param modulation modulation frequency (NONE, LOW, MEDIUM, HIGH)
     * @return formatted chord grid
     */
    ...
    public String generate(
        ...
        // Parse enums with friendly error messages
        ScaleType scaleType;
    ...
    /** Lists all available scale types. */
    ...
    /** Lists available harmony styles. */
